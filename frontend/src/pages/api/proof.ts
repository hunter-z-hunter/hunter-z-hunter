...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    //   target: HZH_ADDRESS,
    //   value: 0,
    //   data: hzhInterface.encodeFunctionData("verifyAndAwardPrize", [huntId, address, encodedProof]), // const encodedProof = defaultAbiCoder.encode(['uint256[8]', 'uint256', 'uint256', 'bytes32', 'uint256'], [solidityProof,group.root,nullifierHash,signalBytes32,externalNullifier])
