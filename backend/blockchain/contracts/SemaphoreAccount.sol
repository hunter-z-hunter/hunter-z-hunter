...
contract SemaphoreAccount is BaseAccount, UUPSUpgradeable, Initializable {
    ...
    event SimpleAccountInitialized(IEntryPoint indexed entryPoint, address indexed owner, address indexed semaphore);
    ...
    function _initialize(address anOwner) internal virtual {
        owner = anOwner;
        emit SimpleAccountInitialized(_entryPoint, owner, address(semaphore));
    }
